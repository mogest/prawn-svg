...
describe Prawn::Svg::Document do  
  ...
  describe :points do    
    it "converts a variety of measurement units to points" do
      ...
      @document.send(:points, "32mm").should be_close(32 * 72 * 0.0393700787, 0.0001)
      @document.send(:points, "32cm").should be_close(32 * 72 * 0.393700787, 0.0001)
      @document.send(:points, "32m").should be_close(32 * 72 * 39.3700787, 0.0001)
