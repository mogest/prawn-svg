module Prawn::SVG
  class Properties
    ...
    PROPERTIES = {
      'alignment-baseline' => Config.new('auto', false,
        %w[auto baseline before-edge text-before-edge middle central after-edge text-after-edge ideographic alphabetic hanging mathematical]),
